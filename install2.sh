...
packagelist='base base-devel linux-zen linux-zen-headers linux-firmware vi vim sudo grub dosfstools efibootmgr zsh curl wget bat ufw git cifs-utils openssh htop man dhcpcd os-prober ntfs-3g'
