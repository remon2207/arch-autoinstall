...
if [ "$3" = "xfce" ] ; then
    ...
    packagelist="$packagelist evince gdm gnome-control-center gnome-keyring gnome-shell gnome-terminal gvfs gvfs-smb mutter nautilus xdg-user-dirs-gtk dconf-editor gnome-tweaks audacious"
elif [ "$3" = "mate" ] ; then
